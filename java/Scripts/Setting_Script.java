...
public class Setting_Script extends Basefunctions {
	...
	@Test(dataProvider= "setting_page",dataProviderClass=Dataproviders.dp_login.class,enabled=true,priority=4,groups={"SMK","REG"})
	...
	@Test(dataProvider= "setting_page",dataProviderClass=Dataproviders.dp_login.class,enabled=true,priority=6,groups={"SMK","REG"})
	...
	@Test(dataProvider= "setting_page",dataProviderClass=Dataproviders.dp_login.class,enabled=true,priority=9,groups={"SMK","REG"})
